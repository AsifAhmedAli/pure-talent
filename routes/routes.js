...
router.post(
    "/change-password",verifyToken,authMiddleware,
    users_controller.change_password
  );
  // send verification code

router.post(
    "/send-verification-code",verifyToken,authMiddleware,
    users_controller.send_verification_code
  );
// change email for logged-in user

router.post(
    "/change-email",verifyToken,authMiddleware,
    users_controller.change_email
  );
...
router.post(
    "/get-in-touch",
    messages_controller.get_in_touch
  );
...
router.get("/google/callback", users_controller.googleCallback);
  ...
  router.get('/protected',(req,res)=>{
    res.send("scuucessfully logged-in with google")
  })
  ...
  router.get('/welcome-facebook',(req,res)=>{
    res.send("scuucessfully logged-in with facebook")
  })
  ...
  router.get('/welcome-linkedin',(req,res)=>{
    res.send("scuucessfully logged-in with Linked-in")
  })
